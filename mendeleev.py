...
class MyWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def on_clicked(self):
        ...
        columns = ['Atomic Number','Symbol', 'Element', 'Origin of name', 'Group', 'Period', 'Atomic weight', 'Density', 'Melting point', 'Boiling point', 'Specific heat capacity', 'Electronegativity', 'Abundance in earth`s crust']
