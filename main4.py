...
class TerminalApp(QMainWindow):
    def __init__(self):
        ...
        self.setGeometry(750, 480, 400, 200)
    ...
    def register_entry(self):
        number = self.ID_input.text().strip()
        ...
        if not validate_pass_number(number):
            QMessageBox.critical(self, "Ошибка", "Некорректный ID")
            return
        ...
        QMessageBox.information(self, "Успех", "Вход успешно зарегистрирован")
